...
<div class="form" id="article-grid-search-form-form">
...
<table width="100%" class="table_form table">
	...
	<tr>
          <th width="100" align="right"><span class="row"><?php echo $form->label($model,'uid'); ?>
</span></th>
        <td >
        <div class="row">
	...
	<tr>
          <th width="100" align="right"><span class="row"><?php echo $form->label($model,'miniContent'); ?>
</span></th>
        <td >
        <div class="row">
		
		
		<?php echo $form->textField($model,'miniContent',array('size'=>60,'maxlength'=>255)); ?>
		</div>
        </td>
