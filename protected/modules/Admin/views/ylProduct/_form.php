...
<table width="100%" class="table_form table">
	...
	<tr>
        ...
        <td >
        <div class="row">
		<?php echo $form->textField($model,'pname',array('size'=>60,'maxlength'=>200,'id'=>'txt_uname')); ?>
		<input type="button" id="ylProduct" value="请选择">
...
<?php echo $form->hiddenField($model,'pid',array('id'=>'hid_uid')); ?>
<?php $this->endWidget(); ?>
...
<script language="javascript">
	...
	KindEditor.ready(function(K) {
		editor = K.create('#YlProduct_content', {
					width:'800px',
					height:'500px',
					resizeType : 2,
