...
<table width="100%" class="table_form table">
	...
	<tr>
        ...
        <td >
        <div class="row">
		<?php echo $form->dropDownList($model,'jid',CHtml::listData(BaseData::NewTheory_JYZL(),'id','name')); ?>
    ...
    <tr>
        ...
        <td >
        <div class="row">
		<select name="ViewPoint[pid]" id="ViewPoint_pid">
            <?php echo Post::getSelectTree('请选择',$model->pid);?>
          </select>
		<?php echo $form->error($model,'mid'); ?>
        </div>
        </td>
...
<script language="javascript">
	...
	KindEditor.ready(function(K) {
		editor = K.create('#ViewPoint_content', {
					width:'800px',
					height:'500px',
					resizeType : 2,
