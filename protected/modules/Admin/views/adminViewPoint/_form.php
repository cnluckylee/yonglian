...
<tr>
	...
	<tr>
       <th width="100" align="right"><span style="float:left;">*</span>
        ...
        <td >
        <div class="row">
		  <input type="text" size="30" maxlength="50" name="ViewPoint[aname]" id="Company_city" value="<?php echo $model->aname;?>">
	...
	<tr>
        ...
        <td >
        <div class="row">
			<select name="ViewPoint[CompanyID]" id="Article_CompanyID">
