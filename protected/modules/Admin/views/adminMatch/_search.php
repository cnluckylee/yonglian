...
<div class="form" id="match-grid-search-form-form">
...
<table width="100%" class="table_form table">
	...
	<tr>
          <th width="100" align="right"><span class="row"><?php echo $form->label($model,'stopdate'); ?>
</span></th>
        <td >
        <div class="row">
		
		
		<?php echo $form->textField($model,'stopdate'); ?>
		</div>
        </td>

	</tr>
	<tr>
          <th width="100" align="right"><span class="row"><?php echo $form->label($model,'sszb'); ?>
</span></th>
        <td >
        <div class="row">
	...
	<tr>
          <th width="100" align="right"><span class="row"><?php echo $form->label($model,'ssxb'); ?>
</span></th>
        <td >
        <div class="row">
	...
	<tr>
          <th width="100" align="right"><span class="row"><?php echo $form->label($model,'ssxs'); ?>
</span></th>
        <td >
        <div class="row">
		
		
		<?php echo $form->textField($model,'ssxs'); ?>
		</div>
        </td>
