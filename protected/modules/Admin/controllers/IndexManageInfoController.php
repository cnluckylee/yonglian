...
class IndexManageInfoController extends AdminController
{
	...
	{
		$model=new IndexManageInfo('search');
		$model->unsetAttributes();  // 清理默认值
		if(isset($_GET['IndexManageInfo']))
			$model->attributes=$_GET['IndexManageInfo'];
	...
	{
		$model=new IndexManageInfo;

		// AJAX 表单验证
		$this->performAjaxValidation($model);

		if(isset($_POST['IndexManageInfo']))
		{
			$model->attributes=$_POST['IndexManageInfo'];
	...
	* @param integer $id 主键
	...
	{
		$model=IndexManageInfo::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='index-manage-info-form')
		{
