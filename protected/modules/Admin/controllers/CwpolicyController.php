...
class CwpolicyController extends AdminController
{
	...
	{
		$model=new Cwpolicy('search');
		$model->unsetAttributes();  // 清理默认值
		if(isset($_GET['Cwpolicy']))
			$model->attributes=$_GET['Cwpolicy'];
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Cwpolicy']))
		{
			$model->attributes=$_POST['Cwpolicy'];
	...
	* @param integer $id 主键
	...
	{
		$model=Cwpolicy::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='cwpolicy-form')
		{
