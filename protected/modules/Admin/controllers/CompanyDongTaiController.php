...
class CompanyDongTaiController extends AdminController
{
	...
	{
		$model=new CompanyDongTai('search');
		$model->unsetAttributes();  // 清理默认值
		if(isset($_GET['CompanyDongTai']))
			$model->attributes=$_GET['CompanyDongTai'];
	...
	* @param integer $id 主键
	...
	{
		$model=CompanyDongTai::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='company-dong-tai-form')
		{
