...
<div class="f_left">
<p id="tfFont">『<?php echo $model->name ?>』</p>
</div>
...
<p id="cFont"><?php echo $model->name ?></p>
<div id="cJacket">
...
<td id="lb"><div id="type1" style="cursor:default">
	<div id="graphic2"  onclick="setPdfView(this)" pdf="<?php echo $v['pdf'];?>"><?php echo ($k+1).'.'.$v['title'];?></div></div></td>
</tr>
<?php endforeach;?>
