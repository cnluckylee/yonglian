<?php /* Smarty version Smarty-3.1.12, created on 2013-01-19 08:11:56
         compiled from "E:\wwwroot\yonglian\protected\views\tpl\index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2664650fa473ca84e23-65948544%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a93c0269a424be5b2b01bcc942445ecfce627d07' => 
    array (
      0 => 'E:\\wwwroot\\yonglian\\protected\\views\\tpl\\index.tpl',
      1 => 1356749416,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2664650fa473ca84e23-65948544',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_50fa473cbcc144_72422826',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_50fa473cbcc144_72422826')) {function content_50fa473cbcc144_72422826($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
?>
    <li><a href="<?php echo $_smarty_tpl->tpl_vars['item']->value['remark'];?>
...
<table width="693" cellspacing="0" cellpadding="0" border="0" style=" position:relative;margin-top:10px;">
      ...
      <tr>
        ...
        <?php if ($_smarty_tpl->tpl_vars['rec_company']->value[1]){?>
        	<ul>
        	<?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['rec_company']->value[1]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value){
$_smarty_tpl->tpl_vars['item']->_loop = true;
?>
            	<li style=" display:inline;"><?php echo $_smarty_tpl->tpl_vars['item']->value['name'];?>
</li>
            <?php } ?>
            <ul>
         <?php }?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['company']->value[1]){?>
        	<ul>
        	<?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['company']->value[1]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value){
$_smarty_tpl->tpl_vars['item']->_loop = true;
?>
            	<li style=" display:inline;"><?php echo $_smarty_tpl->tpl_vars['item']->value['name'];?>
      ...
      <tr>
        ...
        <td height="30" style="BORDER-left: gray 1px solid;BORDER-right: gray 1px solid;">
         <?php if ($_smarty_tpl->tpl_vars['rec_company']->value[2]){?>
        	<ul>
        	<?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['rec_company']->value[2]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value){
$_smarty_tpl->tpl_vars['item']->_loop = true;
?>
            	<li style=" display:inline;"><?php echo $_smarty_tpl->tpl_vars['item']->value['name'];?>
        ...
        <td colspan="2">
         <?php if ($_smarty_tpl->tpl_vars['company']->value[2]){?>
        	<ul>
        	<?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['company']->value[2]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value){
$_smarty_tpl->tpl_vars['item']->_loop = true;
?>
            	<li style=" display:inline;"><?php echo $_smarty_tpl->tpl_vars['item']->value['name'];?>
      ...
      <tr>
        ...
        <td height="30" style="BORDER-left: gray 1px solid;BORDER-right: gray 1px solid;">
         ...
         <?php if ($_smarty_tpl->tpl_vars['rec_company']->value[3]){?>
        	<ul>
        	<?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['rec_company']->value[3]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value){
$_smarty_tpl->tpl_vars['item']->_loop = true;
?>
            	<li style=" display:inline;"><?php echo $_smarty_tpl->tpl_vars['item']->value['name'];?>
        ...
        <td colspan="2">
        <?php if ($_smarty_tpl->tpl_vars['company']->value[3]){?>
        	<ul>
        	<?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['company']->value[3]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value){
$_smarty_tpl->tpl_vars['item']->_loop = true;
?>
            	<li style=" display:inline;"><?php echo $_smarty_tpl->tpl_vars['item']->value['name'];?>
      ...
      <tr>
        ...
        <td height="30" style="BORDER-left: gray 1px solid;BORDER-right: gray 1px solid;">
           <?php if ($_smarty_tpl->tpl_vars['rec_company']->value[4]){?>
        	<ul>
        	<?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['rec_company']->value[4]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value){
$_smarty_tpl->tpl_vars['item']->_loop = true;
?>
            	<li style=" display:inline;"><?php echo $_smarty_tpl->tpl_vars['item']->value['name'];?>
        ...
        <td colspan="2">
        <?php if ($_smarty_tpl->tpl_vars['company']->value[4]){?>
        	<ul>
        	<?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['company']->value[4]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value){
$_smarty_tpl->tpl_vars['item']->_loop = true;
?>
            	<li style=" display:inline;"><?php echo $_smarty_tpl->tpl_vars['item']->value['name'];?>
      ...
      <tr>
        ...
        <td height="30" style="BORDER-left: gray 1px solid;BORDER-right: gray 1px solid;BORDER-bottom: gray 1px solid;">
          <?php if ($_smarty_tpl->tpl_vars['rec_company']->value[5]){?>
        	<ul>
        	<?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['rec_company']->value[5]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value){
$_smarty_tpl->tpl_vars['item']->_loop = true;
?>
            	<li style=" display:inline;"><?php echo $_smarty_tpl->tpl_vars['item']->value['name'];?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['company']->value[5]){?>
        	<ul>
        	<?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['company']->value[5]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value){
$_smarty_tpl->tpl_vars['item']->_loop = true;
?>
            	<li style=" display:inline;"><?php echo $_smarty_tpl->tpl_vars['item']->value['name'];?>
...
$_smarty_tpl->tpl_vars['item']->_loop = true;
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['item']->key;
?>
    <li><a href="<?php echo $_smarty_tpl->tpl_vars['item']->value['weburl'];?>
" target="_blank"><img width="120" height="40" src="<?php echo $_smarty_tpl->tpl_vars['item']->value['weblogo'];?>
"></a></li> 
	<?php } ?>
</ul>
