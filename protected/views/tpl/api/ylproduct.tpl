...
<div id="districtList" class="districtList">
 ...
 <div class="community">
 	<div class="city_text" id="title_img2">3.产品大类</div>
 ...
 <div class="community">
 	<div class="city_text" id="title_img2">4.产品子类</div>
 	<div class="sel_community">
...
function reloadParent()
{
	if(c1<0)
		...
		if($("#hid_uid",parent.document).length>0){
			$("#hid_uid",parent.document).val(ctid);
		}
		if($("#txt_uname",parent.document).length>0)
			$("#txt_uname",parent.document).val(cityname);
