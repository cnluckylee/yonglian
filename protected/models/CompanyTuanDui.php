...
/**
 * This is the model class for table "{{CompanyTuanDui}}".
 *
 * The followings are the available columns in table '{{CompanyTuanDui}}':
 * @property integer $id
 ...
 */
class CompanyTuanDui extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CompanyTuanDui the static model class
	 */
