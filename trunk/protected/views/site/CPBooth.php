...
<p>
&nbsp;&nbsp;集中展示待选企业顺势而为的单体经营风貌，各栏目的侧重点有助于了解他们各项运行轨迹，本季推出的市场新品和重点营销活动，
...
<div class="top_nav"><!--菜单&播报开始-->
<div class="l"><div id ="left2"></div></div>
<div class="m">
<ul>
<li><a href="#">企业动态</a></li>
<li><a href="#">携手发展</a></li>
...
<div class="r"><div id ="right2"></div></div>
</div>
...
<ul>
 ...
 <table  class="searchForm">
  <tr>
   ...
   <tr>
    <td class="title">一级行业</td>
    <td><input type="text" width="150px" /></td>
    <td class="title">二级行业</td>
    <td><input type="text" width="150px" /></td>
    <td class="title">三级行业</td>
    <td><input type="text" width="150px" /></td>
  </tr>
 <tr>
    <td class="title">企业名称</td>
    <td colspan="5"><input type="text" width="150px" /></td>
  </tr>
</table>
