...
class City extends CActiveRecord
{
	...
	public static function getCityList($cid=null)
	{
		$sqlData = self::model()->findAllByAttributes(array('parent_id'=>1));
		$result = array();
		$result[0] = array('id'=>'','name'=>'请选择');
		foreach($sqlData as $i)
		{
			$arr = $i->attributes;
			$result[$arr['city_id']] = array('id'=>$arr['city_id'],'name'=>$arr['city_name']);
		}
		return $result;
	}
}