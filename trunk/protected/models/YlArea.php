...
/**
 * This is the model class for table "{{yl_area}}".
 *
 * The followings are the available columns in table '{{yl_area}}':
 * @property string $id
...
class YlArea extends CActiveRecord {
     ...
     * @return YlArea the static model class
     */
...
//             array('modules', 'required'),
            ...
            array('id, name, parentid,  controller, action, data, ico, listorder, display', 'safe', 'on' => 'search'),
        );
