...
class IndexMarketInfoController extends AdminController
{
	...
	{
		$model=new IndexMarketInfo('search');
		$model->unsetAttributes();  // 清理默认值
		if(isset($_GET['IndexMarketInfo']))
			$model->attributes=$_GET['IndexMarketInfo'];
	...
	{
		$model=new IndexMarketInfo;

		// AJAX 表单验证
		$this->performAjaxValidation($model);

		if(isset($_POST['IndexMarketInfo']))
		{
			$model->attributes=$_POST['IndexMarketInfo'];
	...
	* @param integer $id 主键
	...
	{
		$model=IndexMarketInfo::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='index-market-info-form')
		{
