...
class MatchApplyController extends AdminController
{
	...
	{
		$model=new MatchApply('search');
		$model->unsetAttributes();  // 清理默认值
		if(isset($_GET['MatchApply']))
			$model->attributes=$_GET['MatchApply'];
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['MatchApply']))
		{
			$model->attributes=$_POST['MatchApply'];
	...
	* @param integer $id 主键
	...
	{
		$model=MatchApply::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='match-apply-form')
		{
