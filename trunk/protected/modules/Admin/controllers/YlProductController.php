...
class YlProductController extends AdminController
{
	...
	{
		$model=new YlProduct('search');
		$model->unsetAttributes();  // 清理默认值
		if(isset($_GET['YlProduct']))
			$model->attributes=$_GET['YlProduct'];
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['YlProduct']))
		{
			$model->attributes=$_POST['YlProduct'];
	...
	* @param integer $id 主键
	...
	{
		$model=YlProduct::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='yl-product-form')
		{
