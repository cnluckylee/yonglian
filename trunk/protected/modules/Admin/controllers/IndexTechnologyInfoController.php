...
class IndexTechnologyInfoController extends AdminController
{
	...
	{
		$model=new IndexTechnologyInfo('search');
		$model->unsetAttributes();  // 清理默认值
		if(isset($_GET['IndexTechnologyInfo']))
			$model->attributes=$_GET['IndexTechnologyInfo'];
	...
	{
		$model=new IndexTechnologyInfo;

		// AJAX 表单验证
		$this->performAjaxValidation($model);

		if(isset($_POST['IndexTechnologyInfo']))
		{
			$model->attributes=$_POST['IndexTechnologyInfo'];
	...
	* @param integer $id 主键
	...
	{
		$model=IndexTechnologyInfo::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='index-technology-info-form')
		{
