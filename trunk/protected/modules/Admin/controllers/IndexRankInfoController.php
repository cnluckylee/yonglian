...
class IndexRankInfoController extends AdminController
{
	...
	{
		$model=new IndexRankInfo('search');
		$model->unsetAttributes();  // 清理默认值
		if(isset($_GET['IndexRankInfo']))
			$model->attributes=$_GET['IndexRankInfo'];
	...
	{
		$model=new IndexRankInfo;

		// AJAX 表单验证
		$this->performAjaxValidation($model);

		if(isset($_POST['IndexRankInfo']))
		{
			$model->attributes=$_POST['IndexRankInfo'];
	...
	* @param integer $id 主键
	...
	{
		$model=IndexRankInfo::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='index-rank-info-form')
		{
