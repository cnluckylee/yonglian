...
class AdminRecColumController extends AdminController
{
	...
	{
		$model=new RecColum('search');
		$model->unsetAttributes();  // 清理默认值
		if(isset($_GET['RecColum']))
			$model->attributes=$_GET['RecColum'];
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['RecColum']))
		{
			$model->attributes=$_POST['RecColum'];
	...
	* @param integer $id 主键
	...
	{
		$model=RecColum::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='rec-colum-form')
		{
