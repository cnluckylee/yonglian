...
class YLNewsController extends AdminController
{
	...
	{
		$model=new YlNews('search');
		$model->unsetAttributes();  // 清理默认值
		if(isset($_GET['YlNews']))
			$model->attributes=$_GET['YlNews'];
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['YlNews']))
		{
			$model->attributes=$_POST['YlNews'];
	...
	* @param integer $id 主键
	...
	{
		$model=YlNews::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='yl-news-form')
		{
