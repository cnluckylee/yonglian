...
<div class="form" id="match-query-grid-search-form-form">
...
<table width="100%" class="table_form table">
	...
	<tr>
          <th width="100" align="right"><span class="row"><?php echo $form->label($model,'subject'); ?>
</span></th>
        <td >
        <div class="row">
	...
	<tr>
          <th width="100" align="right"><span class="row"><?php echo $form->label($model,'condition'); ?>
</span></th>
        <td >
        <div class="row">
	...
	<tr>
          <th width="100" align="right"><span class="row"><?php echo $form->label($model,'other'); ?>
</span></th>
        <td >
        <div class="row">
